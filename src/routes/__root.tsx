...
function NotFoundComponent() {
  return (
    <div className="hero-bg flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        <p className="font-mono text-xs uppercase tracking-[0.3em] text-primary">segfault</p>
  ...
  head: () => ({
    meta: [
      ...
      { title: "DebugX — College Debugging Competition Platform" },
      {
        name: "description",
        content:
          "DebugX runs three-round college debugging competitions with live monitoring, anti-cheat and AI-assisted judging.",
      },
      { property: "og:title", content: "DebugX — College Debugging Competition Platform" },
      {
        property: "og:description",
        content: "Three elimination rounds, live proctoring and AI-assisted code judging.",
      },
